...
typedef struct dg_gen_part
{
	...
	int flags;
} dg_gen_part_t;				/* Build_fptr actually builds the returned
...
void gen_dungeon(level_t *l, coords_t *stairs, size_t stairs_count, int max_rooms, int max_pieces);

dg_piece_t* select_piece(level_t *l, coords_t pos, dir_t dir, dg_list_t *pieces, dg_parts_array_t *parts);
void build_piece(level_t *l, dg_piece_t *p, dg_list_t *pieces, dg_list_t *bo, dg_parts_array_t *parts);
void queue_piece(level_t *l, coords_t pos, dir_t d, dg_piece_t *parent, dg_list_t *pieces, dg_list_t *bo, dg_parts_array_t *parts);

dg_piece_t* create_piece(coords_t pos, int w, int h, int d, dir_t dir, dg_gen_part_t *t, coords_t anchor);

dg_piece_t* point_occupied(level_t *l, coords_t pos, dg_list_t *pieces);
dg_piece_t* intersected_piece(level_t *l, coords_t a, coords_t b, dg_list_t *pieces);
